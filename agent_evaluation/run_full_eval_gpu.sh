#!/bin/bash
#SBATCH --job-name=full_muse_gpu
#SBATCH --output=/home/rornelas5/Wintap_Baseline/agent_evaluation/full_muse_gpu_%j.log
#SBATCH --error=/home/rornelas5/Wintap_Baseline/agent_evaluation/full_muse_gpu_%j.err
...
echo "=========================================================="
echo "Running Self-Contained Muse-Glimmer Full 2024 Evaluation on $(hostname)"
...
echo "=========================================================="
echo "Launching Full Clean Temporal Evaluation (14,619 samples, year==2024)..."
echo "Note: Uses SQLite disk cache (cache/llm_cache.db); fully resumable."
echo "=========================================================="
...
echo "=========================================================="
echo "Full Evaluation Finished Successfully at: $(date)"
echo "=========================================================="
